...
import DeliveryPeriod from "../CFTList/DeliveryPeriod";
// @MUI
import {
  Collapse,
  Button,
      ...
      <Router>
          ...
          >
            ...
            <List className="list" component="nav" aria-label="mailbox folders">
              ...
              <ListItem button divider>
                ...
                {/*{openDashboard ? (
                  <ExpandLess style={{ color: "rgb(132,133,140)" }} />
                ) : (
                  <ExpandMore style={{ color: "rgb(132,133,140)" }} />
                )}*/}
              </ListItem>
              </Link>
        ...
        <Grid item md={9}>
          <Routes>
            ...
            <Route exact path="/delivery_period" element={<DeliveryPeriod />} />
            <Route
              path="*"
              element={
                <div>
